...
export class TodoListsController {
  ...
  create(@Body() createToDoListDto: CreateToDoListDto, @CurrentUser() user: CurrentUserPayload) {
    return this.commandBus.execute(new CreateTodoListCommand(createToDoListDto, user.userId));
  }
  ...
  update(
    ...
    return this.commandBus.execute(new UpdateTodoListCommand(id, updateToDoListDto, user.userId));
  }
  ...
  permanentDelete(@Param('id') id: string, @CurrentUser() user: CurrentUserPayload) {
    return this.commandBus.execute(new PermanentDeleteTodoListCommand(id, user.userId));
  }
}
